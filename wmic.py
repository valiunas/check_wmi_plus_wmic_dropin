...
#ver 1.1  08/18/2022  steve.valiunas   Add support for ACCEPTANCE OF (not action on) Optional args (ie check_wmi_plus's @opt_extra_wmic_args=...'
...
if __name__ == '__main__':
        ...
        parser.add_argument('-o', '--option', action='store', help='Optional parms passed to DCOM.', required=False, default='root/cimv2')
